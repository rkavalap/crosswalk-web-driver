...
#ifndef XWALK_TEST_XWALKDRIVER_PERFORMANCE_LOGGER_H_
#define XWALK_TEST_XWALKDRIVER_PERFORMANCE_LOGGER_H_
...
#endif  // XWALK_TEST_XWALKDRIVER_PERFORMANCE_LOGGER_H_
