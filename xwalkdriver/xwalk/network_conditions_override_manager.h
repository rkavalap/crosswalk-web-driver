...
#ifndef XWALK_TEST_XWALKDRIVER_XWALK_NETWORK_CONDITIONS_OVERRIDE_MANAGER_H_
#define XWALK_TEST_XWALKDRIVER_XWALK_NETWORK_CONDITIONS_OVERRIDE_MANAGER_H_
...
#endif  // XWALK_TEST_XWALKDRIVER_XWALK_NETWORK_CONDITIONS_OVERRIDE_MANAGER_H_
